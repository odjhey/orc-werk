...
| Structured crew reports (append-only handoff history) | no | adapter-owned execution/report log (watchtower recommendation on record) | `crew-report/v1` (schema proposed in issue #12; not registered) | **OPEN GATE — due at M1b design time** |
