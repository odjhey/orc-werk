...
22. [`SCN-022`](SCN-022-ledger-census.md) whole-ledger dated tally of settled assurance verdicts across new and legacy journal layouts, grouped by raw model x verdict x UTC day (issue #285, `CONF-CLI-CENSUS-001` through `-006`)
